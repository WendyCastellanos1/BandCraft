...
<head>
    ...
    <!--  CSS  -->
    <link rel="stylesheet" type="text/plain;charset=UTF-8" href="src/main/webapp/WEB-INF/pub/css/custom.css">

</head>
<body>

<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid" style="background-color:lavender; font-weight: bold" >

       <a class="navbar-brand" href="#" style="background-color: saddlebrown; color: yellow">Band Craft</a>
        <!--   <a class="navbar-brand" href="../../..pub/images/band_craft_small.png" alt = "Band Craft Logo"/>"</a>  -->
