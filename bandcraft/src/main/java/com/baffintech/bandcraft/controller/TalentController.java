...
public class TalentController {
    ...
    public  ModelAndView createSubmit(@Valid CreateTalentFormBean form, BindingResult bindingResult) {
        ...
        // we want to validate the talent doesn't exist in the db, but also check if it's a create
        ...
        // if this is a create:
        if(form.getId() == null) {
            //Talent t = talentDAO.findByNameIgnoreCase(form.getName());    TODO
            Talent t = talentDAO.findByName(form.getName());
...
//
//        List<Talent> talents = talentDAO.findByName(search);
//        response.addObject("talentsKey", talents);
//
//        return response;
//    }
